...
TradePanel/
├── config/
│   ├── config.yaml              # System configuration (1)
│   └── strategies.yaml          # Strategy definitions (2)
├── strategies/                  # 23+ strategy implementations
│   ├── base_strategy.py         # Abstract base class
│   ├── dual_ema_fractal.py      # Example strategy
│   └── [21+ others]
├── forward_test/
│   ├── paper_engine.py          # Signal detection & trade execution
│   └── signal_checker.py        # Data validation
├── backtesting/
...
│   ├── order_manager.py         # Trade placement
│   └── data_feed.py             # Data fetching
├── risk/
│   ├── manager.py               # Position sizing & checks
│   ├── regime_classifier.py     # Market regime detection
│   └── correlation_engine.py    # Portfolio monitoring
├── data/
...
│   └── api/
│       ├── router_data.py       # Data endpoints
│       └── router_logs.py       # Log endpoints
├── scheduler/
