# TradePanel Review Optimizer — 2026-05-03 07:22 UTC

Source: `20260501_backtest_report.json` | Mode: QUICK | Promote ≥ 50.0% | Target ≥ 60.0%
...
| ma_crossover | USDCAD | H1 | 0.0% | **60.0%** | +60.0pp | 3.85 | 1.64 | ✅ PASS |
...
| rsi_pullback | XAUUSD | D1 | 57.6% | **67.1%** | +9.5pp | 5.64 | 2.39 | ✅ PASS |
...
|----------|------|----|-----|--------|----|--------|
| ✅ rsi_pullback | XAUUSD | D1 | **67.1%** | 5.641 | 2.394 | review_optimizer_part_a |
...
| ✅ ma_crossover | USDCAD | H1 | **60.0%** | 3.852 | 1.642 | review_optimizer_part_a |
...
_Generated by `scripts/review_optimizer.py` — 2026-05-03 07:22 UTC_